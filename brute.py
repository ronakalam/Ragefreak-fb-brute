...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              Welcome To Ragefreak. ^_^")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Ragefreak             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: Ragefreak            |"
    print Y+"  |             INSTAGRAM: Ragefreak              |"
    print GL+"  |---------------------------------------------|"
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        ...
        	        print " "
        	        raw_input(WW+"Hacked Successful...")
			sys.exit(1)
    ...
    .s-     --                      .:     -s.
     ...
     -s.     `--`                `.-`     .s-
      ...
      """
         ...
         print wd+" [#] Password List Counted\033[97;1m:", len(nuub),'password'
         print wd+" [#] Password cracking Started..\033[97;1m.........."
         print " "
